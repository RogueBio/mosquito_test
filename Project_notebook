...
- **GC Content After Trimming:** Improved after removing the 50-string A sequence, but decision to remove overrepresented sequences remains debatable.
...
Since these samples had extremely low mapping percentages, they were removed from further analysis to ensure reliable downstream results.

---

Let me know if you’d like more improvements or specific formatting for better visualization! 😃
